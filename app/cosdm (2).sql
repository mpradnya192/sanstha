...
--
-- Table structure for table `cos_districts`
--

CREATE TABLE `cos_districts` (
  `dist_id` int(11) NOT NULL,
  `dist_state_id` int(11) DEFAULT NULL,
  `dist_name` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cos_districts`
--

INSERT INTO `cos_districts` (`dist_id`, `dist_state_id`, `dist_name`) VALUES
(1, 1, 'North Andaman'),
(2, 1, 'South Andaman'),
(3, 1, 'Nicobar'),
(4, 2, 'Adilabad'),
...
--
-- Table structure for table `cos_master`
--

CREATE TABLE `cos_master` (
  `master_id` int(11) NOT NULL,
  `master_name` longtext NOT NULL,
  `master_for` int(11) NOT NULL COMMENT '1 = prefix 2 = current status 3 = Operation Area 4 = classification 1 5 = class 2 6 = class 3 7 = class 4 8 = membership',
  `master_isDelete` int(2) NOT NULL DEFAULT 0,
  `master_createdon` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cos_master`
--

INSERT INTO `cos_master` (`master_id`, `master_name`, `master_for`, `master_isDelete`, `master_createdon`) VALUES
(1, 'The', 1, 0, '2021-12-16 14:40:08'),
(2, 'Shri', 1, 0, '2021-12-16 14:40:08'),
(3, 'Shree', 1, 0, '2021-12-16 14:41:15'),
(4, 'Dr.', 1, 0, '2021-12-16 14:41:15'),
(5, 'Mrs.', 1, 0, '2021-12-16 14:43:14'),
(6, 'Sou.', 1, 0, '2021-12-16 14:43:14'),
(7, 'Aadarniy', 1, 0, '2021-12-16 14:43:14'),
(8, 'Manniy', 1, 0, '2021-12-16 14:43:14'),
(9, 'Late', 1, 0, '2021-12-16 14:43:14'),
(10, 'Fully Active', 2, 0, '2021-12-16 14:43:55'),
(11, 'Partially Active', 2, 0, '2021-12-16 14:43:55'),
(12, 'Under Administrator', 2, 0, '2021-12-16 14:45:04'),
(13, 'Under Liquidation', 2, 0, '2021-12-16 14:45:04'),
(14, 'Defunct', 2, 0, '2021-12-16 14:45:04'),
(15, 'Not Known', 2, 0, '2021-12-16 14:45:04'),
(16, 'Multistate', 3, 0, '2021-12-16 14:45:51'),
(17, 'State', 3, 0, '2021-12-16 14:45:51'),
(18, 'District', 3, 0, '2021-12-16 14:46:58'),
(19, 'Taluka', 3, 0, '2021-12-16 14:46:58'),
(20, 'City', 3, 0, '2021-12-16 14:46:58'),
(21, 'Village', 3, 0, '2021-12-16 14:46:58'),
(22, 'Division', 3, 0, '2021-12-16 14:46:58'),
(23, 'Ward', 3, 0, '2021-12-16 14:46:58'),
(24, 'Not known', 3, 0, '2021-12-16 14:46:58'),
(25, 'Urban', 4, 0, '2021-12-16 14:48:06'),
(26, 'Semi-Urban', 4, 0, '2021-12-16 14:48:06'),
(27, 'Rural', 4, 0, '2021-12-16 14:48:28'),
(28, 'Not Known', 4, 0, '2021-12-16 14:48:28'),
(29, 'Mahila', 5, 0, '2021-12-16 14:49:15'),
(30, 'SC-ST', 5, 0, '2021-12-16 14:49:15'),
(31, 'Salary Earners', 5, 0, '2021-12-16 14:49:38'),
(32, 'Not Known', 5, 0, '2021-12-16 14:49:38'),
(33, 'Scheduled', 6, 0, '2021-12-16 14:52:52'),
(34, 'Non-Scheduled', 6, 0, '2021-12-16 14:52:52'),
(35, 'Not Known', 6, 0, '2021-12-16 14:53:09'),
(36, 'DCC', 7, 0, '2021-12-16 14:53:36'),
(37, 'Apex Body', 7, 0, '2021-12-16 14:53:36'),
(38, 'Federation', 7, 0, '2021-12-16 14:55:01'),
(39, 'Association', 7, 0, '2021-12-16 14:55:01'),
(40, 'Council', 7, 0, '2021-12-16 14:55:01'),
(41, 'Union', 7, 0, '2021-12-16 14:55:01'),
(42, 'Board', 7, 0, '2021-12-16 14:55:01'),
(43, 'Not Known', 7, 0, '2021-12-16 14:55:01'),
(44, 'LIVE', 8, 0, '2021-12-16 14:55:42'),
(45, 'EXPIRED', 8, 0, '2021-12-16 14:55:42'),
(46, 'BLOCKED', 8, 0, '2021-12-16 14:55:55');
...
CREATE TABLE `cos_pickup` (
  `c_id` int(11) NOT NULL,
  `c_type` int(2) NOT NULL COMMENT '1=classification1\r\n2=classification2\r\n3=classification3\r\n4=classification4\r\n5= sanstha Status\r\n6=operation area\r\n7=name prefix\r\n',
...
(10, 7, 'Late', 0),
(11, 5, 'Fully Active', 0),
(12, 5, 'Partially Active', 0),
(13, 5, 'Under Administrator', 0),
(14, 2, ' SC-ST', 0),
(15, 2, 'Salary Earners', 0),
(16, 3, ' Non-Scheduled', 0),
(17, 3, 'Not Known', 0),
(18, 4, 'DCC', 0),
(19, 4, 'Apex Body', 0),
(20, 4, 'Federation', 0),
...
--
-- Table structure for table `cos_prefix`
--

CREATE TABLE `cos_prefix` (
  `p_id` int(11) NOT NULL,
  `p_name` varchar(200) NOT NULL,
  `p_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `cos_sanstha` (
  ...
  `cs_sub_type` int(2) NOT NULL,
  `cs_head_off_district` int(11) NOT NULL,
  ...
  `cs_membership_status` varchar(200) DEFAULT NULL,
...
INSERT INTO `cos_sanstha` (`cs_id`, `cs_prefix`, `cs_name`, `cs_state`, `cs_district`, `cs_taluka`, `cs_zone`, `cs_type`, `cs_sub_type`, `cs_head_off_district`, `cs_head_off_addr`, `cs_head_off_place`, `cs_head_off_pincode`, `cs_head_off_std_code`, `cs_head_off_landline`, `cs_head_off_mobile`, `cs_head_off_email`, `cs_status`, `cs_foundation_year`, `cs_years`, `cs_operation_area`, `cs_classification1`, `cs_classification2`, `cs_classification3`, `cs_classification4`, `cs_membership_status`, `cs_membership_start_date`, `cs_membership_end_date`, `cs_desc`, `cs_createdBy`, `cs_approvedBy`, `cs_modifiedBy`, `cs_createdOn`, `cs_modifiedOn`, `cs_approvedOn`, `cs_isDelete`) VALUES
(17, '4', ' Jay Ahom Cooperative Sanstha ltd Marigaon', 4, NULL, 0, NULL, 1, 2, 0, '	334C, Main Road, 									', '	Marigaon																			    										    										    ', '23544221', NULL, 213, 12458798, 'Jayahom@gmail.com', NULL, 0, NULL, NULL, 1, 2, 3, 4, 'Golden', '2020-02-04', '2025-02-03', NULL, 10, NULL, NULL, '2021-11-29 09:25:24', NULL, '0000-00-00 00:00:00', 0),
(19, 'Please sel', ' Janata Sahakari Bank', 12, NULL, 0, NULL, 1, 2, 0, 'test kjhfkhfs				', 'test																				    										    ', '987456', NULL, 123, 12458798, 'sahjdj@hsdjfhksj.jifue', NULL, 0, NULL, NULL, 0, 0, 0, 0, '', '2021-11-29', '2022-11-29', NULL, 10, NULL, NULL, '2021-11-29 10:20:51', NULL, '0000-00-00 00:00:00', 0),
(21, '1', 'test by nimble', 22, NULL, 0, NULL, NULL, 0, 0, '	gfdgf									', '		fgfgfg																		    										    										    										    										    										    ', 'fgfg', NULL, 258235698, 1245879812, 'sahjdj@hsdjfhksj.jifue', NULL, 2012, NULL, NULL, 27, 30, 34, 0, '', '0000-00-00', '0000-00-00', NULL, 3, NULL, NULL, '2021-12-20 10:31:43', NULL, '0000-00-00 00:00:00', 0),
(22, '2', 'nimble', 10, NULL, 0, NULL, NULL, 0, 0, 'ksaajdksajdsj							', 'waewre							', '987456', NULL, 123, 12458798, 'Jayahom@gmail.com', NULL, 1905, NULL, NULL, 0, 0, 0, 40, '45', '2021-12-01', '2021-12-30', NULL, 3, NULL, NULL, '2021-12-20 10:36:14', NULL, '0000-00-00 00:00:00', 0),
(23, 'Please sel', 'test by nimble', 4, NULL, 0, NULL, NULL, 0, 0, 'test', 'tesyt2																					    ', '987456', NULL, 12345, 2147483647, 'sahjdj@hsdjfhksj.jifue', NULL, 0, NULL, NULL, 0, 0, 0, 0, '', '0000-00-00', '0000-00-00', NULL, 3, NULL, NULL, '2021-12-22 09:45:09', NULL, '0000-00-00 00:00:00', 0),
(25, 'Please sel', 'S K P M', 21, NULL, 0, NULL, NULL, 0, 0, 'At post - Kolambe, Taluka : Sangameshwar										', 'Kolambe.											    ', '411045', NULL, 1234567890, 2147483647, 'Jayahom@gmail.com', NULL, 0, NULL, NULL, 0, 0, 0, 0, 'Golden', '2020-06-08', '2021-12-29', NULL, 3, NULL, NULL, '2021-12-23 05:47:13', NULL, '0000-00-00 00:00:00', 0),
(26, '2', 'S K P M', 21, 2777, 0, NULL, NULL, 0, 0, 'At post - Kolambe, Taluka : Sangameshwar										', 'Kolambe.	', '411045', NULL, 1234567890, 2147483647, 'Jayahom@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, '2021-12-23 05:47:27', NULL, '0000-00-00 00:00:00', 0),
(27, '2', 'S K P M', 21, 2777, 0, NULL, NULL, 0, 0, 'At post - Kolambe, Taluka : Sangameshwar										', 'Kolambe.	', '411045', NULL, 1234567890, 2147483647, 'Jayahom@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, '2021-12-23 05:47:34', NULL, '0000-00-00 00:00:00', 0),
(28, '2', 'S K P M', 21, 2777, 0, NULL, NULL, 0, 0, 'At post - Kolambe, Taluka : Sangameshwar										', 'Kolambe.	', '411045', NULL, 1234567890, 2147483647, 'Jayahom@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, '2021-12-23 05:56:28', NULL, '0000-00-00 00:00:00', 0),
(29, 'Please sel', 'S K P M', 21, NULL, 0, NULL, NULL, 0, 0, 'dggds											', 'sdfsdfsdf																				    										    ', '232132', NULL, 1234567890, 2147483647, 'sahjdj@hsdjfhksj.jifue', NULL, 0, NULL, NULL, 0, 0, 0, 0, '', '0000-00-00', '0000-00-00', NULL, 3, NULL, NULL, '2021-12-23 05:57:26', NULL, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cos_sanstha_branches`
--

CREATE TABLE `cos_sanstha_branches` (
  `sb_id` int(11) NOT NULL,
  `sb_sanstha_id` int(11) NOT NULL,
  `sb_branch_nos` int(3) NOT NULL,
  `sb_estension_counters` int(3) NOT NULL,
  `sb_members_count` int(3) NOT NULL,
  `sb_annual_turnover` int(11) NOT NULL,
  `sb_isDelete` int(2) NOT NULL DEFAULT 0,
  `sb_createdOn` timestamp NOT NULL DEFAULT current_timestamp(),
  `sb_createdBy` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cos_sanstha_branches`
--

INSERT INTO `cos_sanstha_branches` (`sb_id`, `sb_sanstha_id`, `sb_branch_nos`, `sb_estension_counters`, `sb_members_count`, `sb_annual_turnover`, `sb_isDelete`, `sb_createdOn`, `sb_createdBy`) VALUES
(1, 2, 23, 1, 3, 3, 0, '2021-11-26 11:12:39', 0),
(2, 2, 22, 22, 22, 22, 0, '2021-11-26 11:12:39', 0),
(3, 2, 22, 22, 22, 22, 0, '2021-11-26 11:12:39', 0),
(4, 17, 21, 20, 473, 98, 0, '2021-11-29 09:35:13', 0),
(5, 20, 223, 2323, 323, 2323, 0, '2021-12-23 09:13:04', 0),
(6, 21, 10, 100, 10000, 434, 0, '2021-12-23 09:15:51', 0),
(7, 21, 15, 45, 500, 50, 0, '2021-12-23 09:21:18', 0),
(8, 21, 15, 45, 500, 50, 0, '2021-12-23 09:23:24', 0),
(9, 21, 54356435, 0, 0, 0, 0, '2021-12-23 10:15:55', 3);
...
CREATE TABLE `cos_sanstha_details` (
...
INSERT INTO `cos_sanstha_details` (`csd_id`, `csd_sanstha_id`, `csd_chairman_name`, `csd_chairman_mobile`, `csd_md_name`, `csd_md_mobile`, `csd_createdOn`, `csd_createdBy`, `csd_isDelete`) VALUES
(1, 5, 'a', '2837283723', 'b', '9874563210', '2021-08-10 11:45:44', 3, 0),
(2, 2, 'efergreg', '', '', '', '2021-11-26 11:51:49', 10, 0),
(3, 6, 'test', '434534434', 'rhfgbhghb', '2323123', '2021-11-26 12:15:23', 10, 0),
(4, NULL, 'lmnop wxyz', '254813569', 'hijkl defgh', '4515', '2021-11-29 09:25:24', 10, 0),
(5, 17, 'lmnop wxyz', '32232323', 'hijkl defgh', '4515', '2021-11-29 09:35:13', 10, 0),
(6, NULL, 'lmnop wxyz', '2374892374', 'rhfgbhghb', '3243232333', '2021-11-29 09:45:55', 10, 0),
(7, NULL, 'test', '32232323', 'kjckxvjk', '2323123', '2021-11-29 10:20:51', 10, 0),
(8, NULL, 'N.M. Deshmukh', '974563210', 'K. D. Joshi', '9874561230', '2021-11-29 11:19:45', 10, 0),
(9, 21, 'sadsada', 'sdsad', 'sdsad', 'sdsadsad', '2021-12-23 09:28:34', 3, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cos_sanstha_membership`
--

CREATE TABLE `cos_sanstha_membership` (
  `mem_id` int(11) NOT NULL,
  `mem_sanstha_id` int(11) DEFAULT NULL,
  `mem_membership_status` varchar(200) DEFAULT NULL,
  `mem_start_date` datetime DEFAULT NULL,
  `mem_end_date` datetime DEFAULT NULL,
  `mem_isDelete` int(2) DEFAULT 0,
  `mem_remark` longtext DEFAULT NULL,
  `mem_createdOn` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cos_sanstha_membership`
--

INSERT INTO `cos_sanstha_membership` (`mem_id`, `mem_sanstha_id`, `mem_membership_status`, `mem_start_date`, `mem_end_date`, `mem_isDelete`, `mem_remark`, `mem_createdOn`) VALUES
(1, 20, 'Pending', '2021-11-01 00:00:00', '2023-11-30 00:00:00', 0, '', '2021-12-23 09:13:04'),
(2, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:15:51'),
(3, 21, 'Expired', '2020-01-03 00:00:00', '2021-11-30 00:00:00', 0, '', '2021-12-23 09:23:24'),
(4, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:25:10'),
(5, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:26:25'),
(6, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:28:20'),
(7, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:28:34'),
(8, 21, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 09:32:55'),
(9, NULL, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 10:15:35'),
(10, NULL, 'Pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', '2021-12-23 10:15:55');

-- --------------------------------------------------------

--
-- Table structure for table `cos_sector`
--

CREATE TABLE `cos_sector` (
  `sector_id` int(11) NOT NULL,
  `sector_name` varchar(200) NOT NULL,
  `sector_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cos_sector`
--

INSERT INTO `cos_sector` (`sector_id`, `sector_name`, `sector_isDelete`) VALUES
(1, 'sector type 1', 0),
(2, 'sector type 2', 0);
...
(17, 'KARNATAKA', 101, 3),
(18, 'KERALA', 101, 3),
(19, 'LAKSHADWEEP', 101, 3),
(20, 'MADHYA PRADESH', 101, 5),
(21, 'MAHARASHTRA', 101, 2),
(22, 'MANIPUR', 101, 6),
(23, 'MEGHALAYA', 101, 6),
(24, 'MIZORAM', 101, 6),
(25, 'NAGALAND', 101, 6),
(26, 'ODISHA', 101, 1),
(27, 'PONDICHERRY', 101, 3),
(28, 'PUNJAB', 101, 4),
(29, 'RAJASTHAN', 101, 2),
(30, 'SIKKIM', 101, 6),
(31, 'TAMIL NADU', 101, 3),
(32, 'TRIPURA', 101, 6),
(33, 'UTTAR PRADESH', 101, 4),
(39, 'UTTARAKHAND', 101, 4),
(34, 'VAISHALI', 101, 0),
(35, 'WEST BENGAL', 101, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cos_subsector`
--

CREATE TABLE `cos_subsector` (
  `ss_id` int(11) NOT NULL,
  `ss_sector_id` int(11) NOT NULL,
  `ss_name` varchar(200) NOT NULL,
  `ss_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cos_subsector`
--

INSERT INTO `cos_subsector` (`ss_id`, `ss_sector_id`, `ss_name`, `ss_isDelete`) VALUES
(1, 1, 'subsector type 1', 0),
(2, 1, 'subsector type 2', 0),
(3, 2, 'subsector type 1', 0),
(4, 2, 'subsector type 2', 0);
...
(7, 10, '$2y$10$ctm9mVMJhWLcTwUhN2EpeOfZRH6p.jkImi4BcitNaMuQpPJNxJboC', 1, '2021-08-13 08:53:46', NULL, '::1', 'Windows 8.1'),
(8, 10, '$2y$10$bUcVDdIc7vu1tplKwwR.iOi0LNOSyVwHXQ8EsRSlHFHEJNVEHqLv2', 1, '2021-08-16 07:34:21', NULL, '::1', 'Windows 8.1'),
(9, 10, '$2y$10$RwnUzaqcdFCoOXbfs.aHreQ54MhOmKnMLEwfsKjtvQxPnN04oVq.e', 1, '2021-08-18 05:48:52', NULL, '::1', 'Windows 8.1'),
(10, 10, '$2y$10$.Cj2kn0BYWzi/pN0MsFydewBo25r05wgsnTzDxqLMD3Wm9xJB7x4G', 1, '2021-08-18 09:49:28', NULL, '::1', 'Windows 8.1'),
(11, 10, '$2y$10$Q54WRAyqeu3qyw6ouE0eHuocnFvLksqxfv7z.h7saDmX/fwgpCWIq', 1, '2021-08-19 05:27:09', NULL, '::1', 'Windows 8.1'),
(12, 10, '$2y$10$14Oc/450NhyloMtltv9roOJQBImwSEJfJY1EYfQov5zAZf7nCbaue', 1, '2021-08-19 09:06:48', NULL, '::1', 'Windows 8.1'),
(13, 10, '$2y$10$AtFIFQ8JYdUWsZZ.GFjqc.ojR0pN77DvTPPeFmBUdeLbTlfzTWv3q', 1, '2021-08-20 11:22:31', NULL, '127.0.0.1', 'Windows 8.1'),
(14, 10, '$2y$10$9qVdNt5HpDepdF2IsSZaTeiRqR7XHaKJ3AbDrTwGIhZ8Vw5DQJBqO', 1, '2021-08-21 06:28:08', NULL, '::1', 'Windows 8.1'),
(15, 10, '$2y$10$wrbgY1u4JhmdMki3/.wda.RJavXRZfTdkTyhs9Z1.ZWtES4.dezD.', 1, '2021-08-23 07:28:44', NULL, '::1', 'Windows 8.1'),
(16, 10, '$2y$10$Wb0k6vPPH7QlgDGCdwg4XOAnlJ/avb6rGAakV8hsAlO01QGmdx3Ja', 1, '2021-08-24 06:57:23', NULL, '::1', 'Windows 8.1'),
(17, 3, '$2y$10$VvXJbLkIS0FQp1uAtGQBVuo6gI6JfKY.EB27TQ.kejfunjIt8xhfO', 1, '2021-09-14 10:21:32', NULL, '::1', 'Windows 8.1'),
(18, 10, '$2y$10$z6kiB0fJRizG03J0m.hLuuELnIWz1skfAV9yyAEiGYHptFKImVcSK', 1, '2021-11-24 11:50:39', NULL, '::1', 'Windows 8.1'),
(19, 10, '$2y$10$TNQvIwjg22Ot0AbC5OCKgeWHUNin476OSpiC3hMXqwyrieN5axrlO', 1, '2021-11-25 06:14:37', NULL, '::1', 'Windows 8.1'),
(20, 10, '$2y$10$mEw8Mq7U6QKE/AHX8IW7AuWjDh917NsSMnYLCxEy/cdgqt2kiWRRe', 1, '2021-11-26 06:44:33', NULL, '::1', 'Windows 8.1'),
(21, 10, '$2y$10$F2sIT/JoDTyLB4ay2UIh3u0OaUzCaZ1FFnVJ6n0vioJkvBlZWIUIm', 1, '2021-11-29 04:55:35', NULL, '::1', 'Windows 8.1'),
(22, 10, '$2y$10$rKraDL.J1D4KWW1FSgDac.iOMTPy45/JtOgWZqouyDu/s/g8EafhC', 1, '2021-11-29 06:45:39', NULL, '::1', 'Windows 8.1'),
(23, 10, '$2y$10$Xu7ff6HWM5jmlmbacwc3huqYXjSdQwWnquEx7rTD2FHgibTYf1sAy', 1, '2021-12-01 07:02:14', NULL, '::1', 'Windows 8.1'),
(24, 10, '$2y$10$2SwU2.te7SKkpybYpCSBgOcvtWGSKspQ3so090cFMUBLxegKfMAx6', 1, '2021-12-01 09:00:57', NULL, '::1', 'Windows 8.1'),
(25, 3, '$2y$10$4AWKLM3hUXq9UeUZ.H39DOQVcWXFzAf.dtOlyHZhp1SMIPgOoOiDy', 1, '2021-12-16 05:27:17', NULL, '::1', 'Windows 8.1'),
(26, 3, '$2y$10$Hl.BKsPiODv4F1UidsSFD.Nh2BP9HEDlKwbxGnDxIuX0B/Mj9S9sG', 1, '2021-12-16 12:47:01', NULL, '::1', 'Windows 8.1'),
(27, 3, '$2y$10$5VgWJ1jqfnDDylsfyEN79Owo2dJU6Wv8hvZ930znN0eYThBRMtHee', 1, '2021-12-20 09:31:05', NULL, '::1', 'Windows 8.1'),
(28, 3, '$2y$10$S0Ryn94/jBNDdlw0hqw61eDAeM2pRDDpeNEDS3HDCukTfo8bceOS2', 1, '2021-12-21 04:42:38', NULL, '::1', 'Windows 8.1'),
(29, 3, '$2y$10$/LJ7OH2dwq.Dl6dhU5U/su20p2DjmRHGsK7akLhfTXJ9HlHpRHvhO', 1, '2021-12-22 09:42:31', NULL, '::1', 'Windows 8.1'),
(30, 3, '$2y$10$1N.V.MZkue46wQFeTB3JneH1YOval4FVBP8JqEFTcFjIeJGbiUIs2', 1, '2021-12-23 04:43:01', NULL, '::1', 'Windows 8.1'),
(31, 3, '$2y$10$FQFFZr450RiIluwNusmvYeH4/6atExMghk03CeZDDEj/b.bx5Jl6i', 1, '2021-12-23 09:38:54', NULL, '::1', 'Windows 8.1');
...
CREATE TABLE `sh_customer` (
  ...
  `cust_company_name` varchar(100) NOT NULL,
  `cust_country` int(11) NOT NULL,
  `cust_state` int(11) NOT NULL,
  `cust_city` varchar(100) NOT NULL,
  `cust_pincode` varchar(8) NOT NULL,
  `cust_mobile` varchar(10) NOT NULL,
  `cust_email` varchar(100) NOT NULL,
  `cust_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `cust_isDelete` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sh_customer` (`cust_id`, `cust_first_name`, `cust_last_name`, `cust_company_name`, `cust_country`, `cust_state`, `cust_city`, `cust_pincode`, `cust_mobile`, `cust_email`, `cust_createdOn`, `cust_isDelete`) VALUES
(1, 'nimble', 'test', 'nimble-esolutions', 101, 22, '', '411038', '9874563210', 'applicationdevelopment@nimble-esolutions.com', '2021-08-20 12:28:34', 0);
...
CREATE TABLE `sh_order` (
  ...
  `or_createdBy` int(11) NOT NULL,
  `or_createdOn` timestamp NOT NULL DEFAULT current_timestamp(),
  `or_status` int(2) DEFAULT 0 COMMENT '0=Pending payment 1=Processing\r\n2=on hold 3=completed 4=cancelled 5=refunded  6=failed',
  `or_item` int(2) DEFAULT NULL,
  `or_cust_id` int(11) NOT NULL,
  `or_total_payment` int(11) DEFAULT NULL,
  `or_payment_status` int(2) DEFAULT 0 COMMENT '0= pending 1=done 2=aborted 3=failed',
  `or_status_modifiedBy` int(11) DEFAULT NULL,
  `or_status_modifiedOn` datetime DEFAULT NULL,
  `or_isDelete` int(2) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sh_order` (`or_id`, `or_createdBy`, `or_createdOn`, `or_status`, `or_item`, `or_cust_id`, `or_total_payment`, `or_payment_status`, `or_status_modifiedBy`, `or_status_modifiedOn`, `or_isDelete`) VALUES
(1, 1, '2021-08-20 10:53:06', 0, 2, 1, 2000, 0, 1, '2021-08-20 16:22:16', 0);
...
CREATE TABLE `sh_order_address` (
  ...
  `add_order_id` int(11) NOT NULL,
  `add_cust_id` int(11) NOT NULL,
  `add_type` int(2) NOT NULL DEFAULT 1 COMMENT '1=billng address 2=shipping address',
  `add_country` int(11) NOT NULL,
  `add_state` int(11) NOT NULL,
  `add_city` varchar(100) NOT NULL,
  `add_pincode` varchar(10) NOT NULL,
  `add_landmark` longtext NOT NULL,
  `add_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `sh_order_item`
--

CREATE TABLE `sh_order_item` (
  `oi_id` int(11) NOT NULL,
  `oi_order_id` int(11) NOT NULL,
  `oi_prod_id` int(11) NOT NULL,
  `oi_prod_qty` int(2) NOT NULL,
  `oi_prod_price` float NOT NULL,
  `oi_total_price` float NOT NULL,
  `oi_cgst` int(2) NOT NULL,
  `oi_sgst` int(2) NOT NULL,
  `oi_igst` int(2) NOT NULL,
  `oi_net_price` float NOT NULL,
  `oi_createdBy` int(11) NOT NULL,
  `oi_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `oi_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sh_order_item`
--

INSERT INTO `sh_order_item` (`oi_id`, `oi_order_id`, `oi_prod_id`, `oi_prod_qty`, `oi_prod_price`, `oi_total_price`, `oi_cgst`, `oi_sgst`, `oi_igst`, `oi_net_price`, `oi_createdBy`, `oi_createdOn`, `oi_isDelete`) VALUES
(1, 1, 1, 1, 1000, 1000, 0, 0, 0, 1000, 1, '2021-08-20 10:54:24', 0),
(2, 1, 2, 1, 1000, 1000, 0, 0, 0, 1000, 1, '2021-08-20 10:55:29', 0);
...
CREATE TABLE `sh_product` (
  ...
  `prod_video_link` varchar(500) DEFAULT NULL,
  `prod_download_link` varchar(500) DEFAULT NULL,
  `prod_price` float DEFAULT NULL,
  `prod_sale_price` float DEFAULT NULL,
  `prod_stock_status` varchar(100) DEFAULT NULL,
  `prod_quantity` int(4) DEFAULT NULL,
  `prod_avg_rate` int(4) DEFAULT NULL,
  `prod_total_sale` int(11) DEFAULT NULL,
  `prod_likes` int(4) DEFAULT NULL,
  `prod_createdOn` timestamp NULL DEFAULT NULL,
  `prod_createdBy` int(11) DEFAULT NULL,
  `prod_isDelete` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sh_product` (`prod_id`, `prod_name`, `prod_category`, `prod_desc`, `prod_video_link`, `prod_download_link`, `prod_price`, `prod_sale_price`, `prod_stock_status`, `prod_quantity`, `prod_avg_rate`, `prod_total_sale`, `prod_likes`, `prod_createdOn`, `prod_createdBy`, `prod_isDelete`) VALUES
(1, 'Corporate Law (Concepts)', 1, ' All the concepts covered in a very comprehensive manner\r\n Extensive use of Flowcharts\r\n Exemptions and Penalties (along with Learning Hacks, wherever applicable)\r\nSummaries Included for Effective Learning and Quick Revision\r\n Bare Act Language in a structured manner with detailed breakdown presentation\r\n ICAI SM fully covered\r\n View Sample Pages: Link-', '', '', 349, 299, '1', NULL, NULL, NULL, NULL, '2021-08-19 09:06:28', NULL, 0),
(2, 'Economic Laws(Concepts)', 2, ' All the concepts covered in a very comprehensive manner\r\n Extensive use of Flowcharts\r\n Exemptions and Penalties Summaries Included for Effective Learning and Quick\r\nRevision\r\n Bare Act Language in a structured manner with detailed breakdown presentation\r\n ICAI SM fully covered\r\n View Sample Pages: Link-', '', '', 349, 299, '1', NULL, NULL, NULL, NULL, '2021-08-19 09:08:08', 10, 0),
(3, 'Corporate and Economic Laws (Comprehensive Question Bank)', 2, ' Comprehensive Coverage of close to 750 Questions in just around 300 Pages\r\n Vast coverage from Past Papers, RTPs, MTPs, ICAI SM\r\n Format of “Relevant Answer Points” with “Conclusions”: To Ensure most effective &\r\nefficient coverage of the Questions as well as Quick Revision\r\n View Sample Pages: Link-', '', '', 599, 499, '1', NULL, NULL, NULL, NULL, '2021-08-19 09:09:26', 10, 0),
(4, 'Corporate and Economic Laws (Concepts)', 2, ' All the concepts covered in a very comprehensive manner\r\n Extensive use of Flowcharts\r\n Exemptions and Penalties Summaries Included for Effective Learning and Quick\r\nRevision\r\n Bare Act Language in a structured manner with detailed breakdown presentation\r\n ICAI SM fully covered', '', '', 599, 499, '1', NULL, NULL, NULL, NULL, '2021-08-19 09:10:21', 10, 0),
(5, 'Corporate and Economic Laws (Concepts) + Corporate and Economic Laws (Comprehensive Question Bank)', 2, 'COMBO Offer: Corporate and Economic Laws (Concepts) + Corporate and Economic\r\nLaws (Comprehensive Question Bank)', '', '', 1099, 899, '1', NULL, NULL, NULL, NULL, '2021-08-19 09:11:11', 10, 0);

-- --------------------------------------------------------

--
-- Table structure for table `sh_product_category`
--

CREATE TABLE `sh_product_category` (
  `cat_id` int(11) NOT NULL,
  `cat_name` varchar(100) NOT NULL,
  `cat_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sh_product_category`
--

INSERT INTO `sh_product_category` (`cat_id`, `cat_name`, `cat_isDelete`) VALUES
(1, 'Virtual', 0),
(2, 'Physical', 0);
...
CREATE TABLE `sh_review` (
  ...
  `review_cust_id` int(11) NOT NULL,
  `review_prod_id` int(11) NOT NULL,
  `review_remark` longtext NOT NULL,
  `review_status` int(11) NOT NULL COMMENT '0=pending for approval 1=approved 2=delete ',
  `review_createdOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `sh_upload`
--

CREATE TABLE `sh_upload` (
  `up_id` int(11) NOT NULL,
  `up_type` int(2) DEFAULT NULL COMMENT '1=thumbnail 2=banner',
  `up_type_id` int(11) DEFAULT NULL COMMENT 'that product id',
  `up_url` varchar(200) DEFAULT NULL,
  `up_createdBy` int(11) DEFAULT NULL,
  `up_createdOn` timestamp NULL DEFAULT NULL,
  `up_isDelete` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sh_upload`
--

INSERT INTO `sh_upload` (`up_id`, `up_type`, `up_type_id`, `up_url`, `up_createdBy`, `up_createdOn`, `up_isDelete`) VALUES
(1, 1, 1, 'http://localhost/Co-sanstha/assest/images/Food-Services.jpg', 1, NULL, 0),
(2, 2, 1, 'http://localhost/Co-sanstha/assest/images/Food-Services.jpg', 1, '2021-08-19 09:16:12', 0);
...
--
-- Indexes for table `cos_districts`
--
ALTER TABLE `cos_districts`
  ADD PRIMARY KEY (`dist_id`);

--
-- Indexes for table `cos_master`
--
ALTER TABLE `cos_master`
  ADD PRIMARY KEY (`master_id`);

--
-- Indexes for table `cos_pickup`
--
ALTER TABLE `cos_pickup`
  ADD PRIMARY KEY (`c_id`);

--
-- Indexes for table `cos_prefix`
--
ALTER TABLE `cos_prefix`
  ADD PRIMARY KEY (`p_id`);

--
-- Indexes for table `cos_region`
--
ALTER TABLE `cos_region`
  ADD PRIMARY KEY (`reg_id`);

--
-- Indexes for table `cos_sanstha`
--
ALTER TABLE `cos_sanstha`
  ADD PRIMARY KEY (`cs_id`);

--
-- Indexes for table `cos_sanstha_branches`
--
ALTER TABLE `cos_sanstha_branches`
  ADD PRIMARY KEY (`sb_id`);

--
-- Indexes for table `cos_sanstha_details`
--
ALTER TABLE `cos_sanstha_details`
  ADD PRIMARY KEY (`csd_id`);

--
-- Indexes for table `cos_sanstha_membership`
--
ALTER TABLE `cos_sanstha_membership`
  ADD PRIMARY KEY (`mem_id`);

--
-- Indexes for table `cos_sector`
--
ALTER TABLE `cos_sector`
  ADD PRIMARY KEY (`sector_id`);

--
-- Indexes for table `cos_subsector`
--
ALTER TABLE `cos_subsector`
...
--
-- Indexes for table `cos_user_role`
--
ALTER TABLE `cos_user_role`
  ADD PRIMARY KEY (`role_id`);

--
-- Indexes for table `cos_user_session`
--
ALTER TABLE `cos_user_session`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cos_zone`
--
ALTER TABLE `cos_zone`
...
--
-- Indexes for table `sh_order_item`
--
ALTER TABLE `sh_order_item`
...
--
-- Indexes for table `sh_product_category`
--
ALTER TABLE `sh_product_category`
...
--
-- Indexes for table `sh_upload`
--
ALTER TABLE `sh_upload`
...
--
-- AUTO_INCREMENT for table `cos_districts`
--
ALTER TABLE `cos_districts`
  MODIFY `dist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=646;

--
-- AUTO_INCREMENT for table `cos_master`
--
ALTER TABLE `cos_master`
  MODIFY `master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `cos_pickup`
--
ALTER TABLE `cos_pickup`
  MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `cos_prefix`
--
ALTER TABLE `cos_prefix`
  MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cos_region`
--
ALTER TABLE `cos_region`
  MODIFY `reg_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cos_sanstha`
--
ALTER TABLE `cos_sanstha`
  MODIFY `cs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `cos_sanstha_branches`
--
ALTER TABLE `cos_sanstha_branches`
  MODIFY `sb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `cos_sanstha_details`
--
ALTER TABLE `cos_sanstha_details`
  MODIFY `csd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `cos_sanstha_membership`
--
ALTER TABLE `cos_sanstha_membership`
  MODIFY `mem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `cos_sector`
--
ALTER TABLE `cos_sector`
  MODIFY `sector_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `cos_subsector`
--
ALTER TABLE `cos_subsector`
  MODIFY `ss_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cos_user`
--
ALTER TABLE `cos_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `cos_user_role`
--
ALTER TABLE `cos_user_role`
  MODIFY `role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cos_user_session`
--
ALTER TABLE `cos_user_session`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `cos_zone`
--
ALTER TABLE `cos_zone`
...
--
-- AUTO_INCREMENT for table `sh_order_item`
--
ALTER TABLE `sh_order_item`
...
--
-- AUTO_INCREMENT for table `sh_product_category`
--
ALTER TABLE `sh_product_category`
...
--
-- AUTO_INCREMENT for table `sh_upload`
--
ALTER TABLE `sh_upload`
