          ...
          <div class="card">
            ...
            <div class="card-body">
                <!-- <div class="row"> -->
                    <div class="row">
                      <div class="col-sm-8">
                        <form role="form" id="createSanstha" method="post" action="<?php if(!empty(service('uri')->getSegment(3))) { echo site_url('sanstha/sanstha_details/'.service('uri')->getSegment(3).''); }else{ echo site_url('sanstha/sanstha_details'); } ?>">
                          <div class="row">
                            <div class="col-sm-3">
                              <!-- text input -->
                            ...
                            <div class="col-sm-3" style="padding-top: 3.5%;">
                              <!-- text input -->
                              <div class="form-group">
	                ...
	                <tbody>
                      ...
                      ?>
	                  	<tr>
	                  		...
	                  		<td><?php //echo $i++; ?></td>
                        <?php if(service('uri')->getSegment(3) != ''){ ?>
	                  		<td><span style="text-align: center;" data-toggle="modal" data-id="<?php echo $skey['cs_id'] ?>"data-target="#deleteSanstha"><span class="btn btn-icon btn-xs btn-primary" style="padding:.20rem .40rem;"><i class="fa fa-trash-alt" title="Delete"></i></span></span>  &nbsp;
                                <a href="<?php echo site_url('sanstha/update_sanstha/'.$skey['cs_id']) ?>"><span style="align-items: center;padding:.20rem .40rem;"class="btn btn-icon btn-primary btn-xs"><i class="fa fa-edit" title="Update sanstha"></i></span></a> &nbsp;
                                <a href="<?php echo site_url('sanstha/view_sanstha/'.$skey['cs_id']) ?>"><span style="align-items: center;padding:.20rem .40rem;" class="btn btn-primary btn-xs"><i class="fa fa-eye" title="view sanstha"></i></span></a>
                            </td>
                        <?php } ?>
                      </tr>
	                  <?php } }?>
