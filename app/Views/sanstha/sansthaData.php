			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Sanstha Details</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
				...
				<div class="col-md-12">
					...
					<form role="form" id="createSanstha" method="post" action="<?= site_url('cosanstha/sansthaUpdateSave'); ?>">
						<div class="card-body" style="padding: 0.25rem;">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_district" disabled>
												<option>Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_taluka" disabled>
											<option>Please select</option>
											</select>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<?php //print_r($pickup);?>
											<select class="form-control" name="cs_prefix" disabled>
												<option>Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<input type="text" disabled name="cs_name" class="form-control" value="<?php echo $sanstha_data[0]['cs_name'];?>">
											<!-- <input type="hidden" name="cs_id" class="form-control" value="<?php echo $sanstha_data[0]['cs_id'];?>"> -->
										</div>
									</div>
									<div class="col-sm-3">
									<!-- text input -->
									    <div class="form-group">
										    ...
										    <textarea class="form-control" disabled name="cs_head_off_addr" id="" rows="2"><?php echo $sanstha_data[0]['cs_head_off_addr'];?></textarea>
										    <!-- <textarea name="cs_head_off_addr" class="form-control" ><?php echo $sanstha_data[0]['cs_head_off_addr'];?></textarea>					 -->
									    </div>
								    </div>
								    <div class="col-sm-3">
									<!-- text input -->
									    <div class="form-group">
										    ...
										    <textarea class="form-control" disabled id="" name="cs_head_off_place" rows="2"><?php echo $sanstha_data[0]['cs_head_off_place']?></textarea>
										    <!-- <textarea name="cs_head_off_place" class="form-control"><?php echo $sanstha_data[0]['cs_head_off_place']?>
										    </textarea> -->						
									    </div>
								    </div>
									...
									<!-- text input -->
									    <div class="form-group">
										    ...
										    <input type="text"  name="cs_head_off_pincode" disabled class="form-control"  value="<?php echo $sanstha_data[0]['cs_head_off_pincode']?>">
										</div>
								    </div>
								    <div class="col-sm-3">
									<!-- text input -->
									    <div class="form-group">
										    ...
										    <input type="text"  name="cs_head_off_landline" disabled class="form-control" placeholder="00123-4567890"  value="<?php echo $sanstha_data[0]['cs_head_off_landline']?>">
										</div>
								    </div>
								    <div class="col-sm-3">
									<!-- text input -->
									<div class="form-group">
										...
										<input type="text" disabled name="cs_head_off_mobile" class="form-control" placeholder="9874563210"  value="<?php echo $sanstha_data[0]['cs_head_off_mobile']?>">								
									</div>
								</div>
								<div class="col-sm-3">
									<!-- text input -->
									<div class="form-group">
										...
										<input type="email" disabled name="cs_head_off_email" class="form-control" placeholder="abc@gmail.co" value="<?php echo $sanstha_data[0]['cs_head_off_email']?>">				
									</div>
								</div>
								<div class="col-sm-3">
										<!-- text input -->
										<div class="form-group">
											...
											<input type="text" disabled name="cs_website" class="form-control" placeholder="wwww.santha.com" value="<?php echo $sanstha_data[0]['cs_website']?>">	
										</div>
									</div>
								</div>
							</fieldset>
							<fieldset class="" id="" style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>3. Sanstha Information<span style="color:red;font-size: 14px">  **Either fill complete information else keep empty..</span></h4>
								...
								<div class="row">
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_status" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_foundation_year" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_operation_area" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_classification1" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_classification2" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_classification3" disabled>
												<option value="">Please select</option>
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<select class="form-control" name="cs_classification4" disabled>
												<option value="">Please select</option>
							...
							<fieldset class="" id="" style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>4. Other Details<span style="color:red;font-size: 14px">  **Either fill complete information else keep empty..</span></h4>
								<div class="row">
									<div class="col-md-12">
							...
							<fieldset class="" id="" style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>5. Management Info<span style="color:red;font-size: 14px">  **Either fill complete information else keep empty..</span></h4>								
								<div class="row">
								<div class="col-md-12">
								<table class="table table-bordered">
									<thead>
						...
						<fieldset class="" id="" style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>6. Sahakar Bharati Membership Details<span style="color:red;font-size: 14px">  **Either fill complete information else keep empty..</span></h4><hr>
