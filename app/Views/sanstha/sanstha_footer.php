...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $(document).on('change',"select[name='cs_filter_state']",function(){
      ...
      $.post('<?= site_url('Sanstha/getCity') ?>',{chkVal}, function(cityInfo){
        // console.log(cityInfo);
        $('select[name="cs_filter_district"]').empty();
        $("select[name='cs_filter_district']").append('<option value="">Please select</option>');
        $.each(cityInfo,function(p,q){           
            $("select[name='cs_filter_district']").append('<option value="'+q.dist_id+'">'+q.dist_name+'</option>');            
        });       
      },'JSON');     
    });
    ...
    $(document).on('change',"select[name='cs_sector']",function(){
      ...
      $.post('<?= site_url('Sanstha/getSubSector') ?>',{sector}, function(sectorInfo){
        // console.log(cityInfo);
        $('select[name="cs_subsector"]').empty();
        $("select[name='cs_subsector']").append('<option value="">Please select</option>');
        $.each(sectorInfo,function(p,q){           
            $("select[name='cs_subsector']").append('<option value="'+q.ss_id+'">'+q.ss_name+'</option>');            
        });       
      },'JSON');     
    });
    ...
    $(document).on('click',"#sansthaInfomation",function(){
      ...
      }else if(cs_status == '' && foundation_year == '' && operation_area == '' && (classification_one == '' || classification_two == '' || classification_three == '' || classification_four == '')){
        $('#otherDetails').removeClass('hidden');
        $('#sansthaInfomation').addClass('hidden');       
      }
      else{
    ...
    $(document).on('click','#sansthaOther',function(){
      ...
      }else if(branch_number == '' && extensio_counter == '' && member_count == '' && annual_turnover == '' && as_date == ''){
        $('#managementInfo').removeClass('hidden');
        $('#sansthaOther').addClass('hidden');
      }else{
        alert('Either fill complete information else keep empty');
    ...
    $(document).on('click','#sansthaManagement',function(){
      ...
      }else if(chairman_name == '' && chairman_mobile == '' && chairman_md == '' && chairman_md_mobile == ''){
        $('#membershipDetails').removeClass('hidden');
        $('#sansthaManagement').addClass('hidden');
      }else{
        alert('Either fill complete information else keep empty');
