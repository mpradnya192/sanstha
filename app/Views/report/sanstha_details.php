	                ...
	                <tbody>
                      ...
                      ?>
	                  	<tr>
	                  		...
	                  		<td><?php //echo $i++; ?></td>
                        <?php if(service('uri')->getSegment(3) != ''){ ?>
	                  		 <td><span style="text-align: center;" data-toggle="modal" data-id="<?php echo $skey['cs_id'] ?>"data-target="#deleteSanstha"><span class="btn btn-icon btn-xs btn-primary"><i class="fa fa-trash-alt" title="Delete"></i></span></span>  &nbsp; &nbsp; &nbsp;

                          <a href="<?php echo site_url('sanstha/update_sanstha/'.$skey['cs_id']) ?>"><span style="align-items: center;"class="btn btn-icon btn-primary btn-xs"><i class="fa fa-edit" title="Update sanstha"></i></span></a></td>
                        <?php } ?>
                      </tr>
	                  <?php } }?>
	                </tbody>
