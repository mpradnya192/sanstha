...
//kunjika
$routes->match(['get','post'], 'report/rpt_by_foundation_year', 'Report::rpt_foundation', ['filter'=>'auth']);
$routes->match(['get','post'], 'report/rpt_by_turnover', 'Report::rpt_turnover', ['filter'=>'auth']);
